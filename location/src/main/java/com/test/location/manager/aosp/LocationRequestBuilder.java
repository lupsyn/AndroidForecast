package com.test.location.manager.aosp;
...
import com.test.location.manager.aosp.error.ElderLocationException;
import com.test.location.manager.aosp.error.ProviderDisabledException;
